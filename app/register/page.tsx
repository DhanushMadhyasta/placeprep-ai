    ...
    return (
      <main style={s.root}>
        ...
        <div style={s.successCard} className="fadeUp">
          ...
          <p style={s.successSub}>Welcome, <strong>{form.fullName.split(" ")[0]}</strong>! Redirecting to sign in…</p>
        </div>
      </main>
    );
  }
      ...
      <div style={s.card} className="fadeUp reg-card">
        ...
        <div style={s.fields}>
          ...
          <div style={s.fieldGroup}>
            ...
            <input
              style={s.input}
              placeholder="your_username (used to sign in)"
              value={form.username}
...
const s: Record<string, React.CSSProperties> = {
  ...
  input: {
    padding: "12px 14px", borderRadius: 12, border: "1.5px solid #ddd6f3",
    fontSize: 14, fontFamily: "'DM Sans',sans-serif", color: "#2d2540",
  ...
  successCard: {
    ...
    flexDirection: "column" as const, alignItems: "center", gap: 14,
  ...
  successSub: { fontSize: 14, color: "#6b6080", lineHeight: 1.7, marginBottom: 8 },
};